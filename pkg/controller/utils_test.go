...
func TestUniq(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			"Two service ports",
			[]utils.ServicePort{
				testServicePort("ns", "name", "80", 30080),
				testServicePort("ns", "name", "443", 30443),
			},
			[]utils.ServicePort{
				testServicePort("ns", "name", "80", 30080),
				testServicePort("ns", "name", "443", 30443),
		...
		},
		{
			...
			[]utils.ServicePort{
				testServicePort("ns", "name1", "80", 30080),
				testServicePort("ns", "name2", "80", 30880),
			},
			[]utils.ServicePort{
				testServicePort("ns", "name1", "80", 30080),
				testServicePort("ns", "name2", "80", 30880),
		...
		},
		{
			...
			[]utils.ServicePort{
				testServicePort("ns", "name", "80", 0),
				testServicePort("ns", "name", "443", 0),
			},
			[]utils.ServicePort{
				testServicePort("ns", "name", "80", 0),
				testServicePort("ns", "name", "443", 0),
...
func testServicePort(namespace, name, port string, nodePort int) utils.ServicePort {
