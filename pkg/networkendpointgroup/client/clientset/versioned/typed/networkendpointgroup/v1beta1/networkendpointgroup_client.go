...
import (
	...
	"k8s.io/ingress-gce/pkg/networkendpointgroup/client/clientset/versioned/scheme"
)
...
func (c *NetworkingV1beta1Client) NetworkEndpointGroups(namespace string) NetworkEndpointGroupInterface {
